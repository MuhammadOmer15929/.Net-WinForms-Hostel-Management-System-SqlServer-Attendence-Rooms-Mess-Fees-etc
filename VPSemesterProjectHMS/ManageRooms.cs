    ...
    public partial class ManageRooms : Form
    {
        ...
        private void gunaAdvenceButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "Select  RegNo,Name,Class,Department from StudentsRecord  WHERE RoomNo=" + RoomNo;
        ...
        private void gunaAdvenceButton2_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dialogResult = MessageBox.Show("Are You Sure You Want to Print?", "Rooms Record", MessageBoxButtons.YesNo);
            if (dialogResult == DialogResult.Yes)
            {
                DGVPrinter printer = new DGVPrinter();
                printer.Title = "Rooms Records";
